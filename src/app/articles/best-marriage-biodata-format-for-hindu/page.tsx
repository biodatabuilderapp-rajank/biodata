...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Best Hindu Marriage Biodata Format", item: "https://biodatabuilder.in/articles/best-marriage-biodata-format-for-hindu" },
  ],
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Best Marriage Biodata Format for Hindu",
  description: "Create the best Hindu marriage biodata format online for free. Beautiful templates with Gotra, Nakshatra, and Kundali details. Download PDF instantly.",
  image: "/examples/Hindu-biodata-example.webp",
