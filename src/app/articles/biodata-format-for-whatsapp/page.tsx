...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Biodata Format for WhatsApp", item: "https://biodatabuilder.in/articles/biodata-format-for-whatsapp" },
  ],
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Biodata Format for WhatsApp — Share as PDF or PNG",
  description: "How to share your marriage biodata on WhatsApp as a perfect PDF or PNG image. Tips on format, size, and sharing etiquette.",
  image: "/examples/whatsapp-biodata-infographic.webp",
