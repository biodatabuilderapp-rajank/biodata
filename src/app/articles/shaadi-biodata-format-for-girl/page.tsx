        ...
        <div className="space-y-8 text-zinc-700 dark:text-zinc-300 leading-relaxed text-lg">
          ...
          <div className="mt-16 border-t border-zinc-200 dark:border-zinc-800 pt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link href="/articles/biodata-format-hindi" className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-pink-500 transition group">
                <div className="text-sm text-zinc-500 mb-1">Language</div>
                <div className="font-bold text-zinc-900 dark:text-white group-hover:text-pink-600 transition">Biodata Format in Hindi — हिंदी गाइड</div>
              </Link>
              <Link href="/articles/simple-biodata-format-for-job-pdf" className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-pink-500 transition group">
                <div className="text-sm text-zinc-500 mb-1">Career</div>
                <div className="font-bold text-zinc-900 dark:text-white group-hover:text-pink-600 transition">Job vs Marriage Biodata — Key Differences</div>
              </Link>
              <Link href="/articles/marriage-biodata-statistics-india" className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-pink-500 transition group">
                <div className="text-sm text-zinc-500 mb-1">Research</div>
                <div className="font-bold text-zinc-900 dark:text-white group-hover:text-pink-600 transition">Indian Marriage Biodata Statistics (2024)</div>
              </Link>
            </div>
          </div>
        </div>
