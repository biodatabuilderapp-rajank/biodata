...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Thirumanam Biodata Format Tamil", item: "https://biodatabuilder.in/articles/thirumanam-biodata-format-tamil" },
  ],
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Thirumanam Biodata Format in Tamil — Free Download",
  description: "Create a beautiful Tamil thirumanam biodata format online for free. Download your Tamil marriage biodata as a PDF instantly.",
  image: "/examples/tamil-biodata-infographic.webp",
          ...
          <div className="mt-16 border-t border-zinc-200 dark:border-zinc-800 pt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link href="/articles/biodata-format-hindi" className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-indigo-500 transition group">
                ...
                <div className="font-bold text-zinc-900 dark:text-white group-hover:text-indigo-600 transition">Biodata Format in Hindi — हिंदी विवाह बायोडाटा</div>
              </Link>
